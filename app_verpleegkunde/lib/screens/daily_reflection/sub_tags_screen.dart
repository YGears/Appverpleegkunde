...
/// Class to create the SubTagsScreen view, making a list of all SubTagsScreen available.
/// can favorite leerdoel and look at SubTagsScreen at a different navigation
/// Must run using flutter run --no-sound-null-safety because of shared_preferences

class SubTagsScreen extends StatefulWidget {
  const SubTagsScreen({Key? key}) : super(key: key);

  @override
  _SubTagsScreen createState() => _SubTagsScreen();
}
